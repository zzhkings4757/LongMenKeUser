        ...
        <div class="screen-box">
          ...
          <div class="right-cont">
            ...
            <div class="cont-wrapper" v-show="Index==3">
              <div ref="rentScroll" class="scroll-wrapper">
                <ul class="rent-list">
                  <li v-for="(item,index) in complexList" :key="index" :class="{'dc':rentIndex==index}" @click="selectRent(index)">
                    {{item.text}}
                    <span class="icon iconfont iconduigou flex-center" v-if="rentIndex==index"></span>
                  </li>
                </ul>
...
export default {
  ...
  data() {
    return {
      pathData: 0, //为0时，是分类界面，1时是一键租房界面
      searchVal: '',
      screenIndex: null,
  ...
  methods: {
    ...
    screenInit(){
      ...
      this.aProvince = cityInfo[0]
      this.aCity = cityInfo[1]
